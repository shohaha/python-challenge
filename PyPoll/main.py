...
# Add variable to load csv file from path
csvpath = os.path.join("/Users/missshola/python-challenge/PyPoll/Resources/election_data.csv")

# Add variable to save the file to a path
out_file = os.path.join("/Users/missshola/python-challenge/PyPoll/analysis/Py_Poll.txt")
